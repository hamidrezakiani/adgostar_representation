...
@section('header-title','لیست تیک کاربران')
@section('sidebar')
    @include('layout.admin-sidebar')
@endsection
@section('page-route')
<li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">خانه</a></li>
<li class="breadcrumb-item active" id="ticket-list-route"><a>لیست تیکت های کاربران</a></li>
<li class="breadcrumb-item active" id="ticket-messages-route">جزییات تیکت کاربر</li>
@endsection
@section('content')
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  <strong><i class="fa fa-user mr-1"></i>اطلاعات کاربر</strong>

                  <p class="text-muted" id="ticket-user-fullName"></p>
...
@section('script')
     <script>
      $('#group-user-ticket-sidebar').addClass('active');
      $('#list-user-ticket-sidebar').addClass('active');
      $('#group-user-ticket-menu-open').addClass('menu-open');
     </script>
    <script src="{{asset('dist/js/api/admin-api.js')}}"></script>
    <script src="{{asset('dist/js/pages/admin/userTickets.js')}}"></script>
@endsection
